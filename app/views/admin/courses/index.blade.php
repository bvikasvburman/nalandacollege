        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <a href="{{ URL::action('CourseController@create') }}" class="btn btn-primary ">
			<span class="fa fa-plus"> </span>  Add New 
                ...
                <div class="panel-body">
				    ...
				    <th>Eligibility</th>
					    ...
					    <td>{{ $result->branch }}</td>
					    <td>{{ $result->seat }}</td>
					    <td>{{ $result->admission_norms }}</td>
					    <td>{{ $result->eligibility }}</td>
                                            <td class="action">
                                                <a href="{{ URL::action('CourseController@show', $result->id ) }}" class="btn btn-success btn-circle">
						    <span class="fa fa-eye"></span>
						</a>
                                                    
                                                <a href="{{ URL::action('CourseController@edit', $result->id ) }}" class="btn btn-primary btn-circle">
						    <span class="fa fa-edit"></span>
						</a>
                                                    
                                                {{ Form::open(array('route' => array('admin.courses.destroy', $result->id), 'method' => 'delete', 'style' => 'display:inline-block' , 'id' => 'frm_delete' )) }}
